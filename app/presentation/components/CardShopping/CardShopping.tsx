...
const url =
  'https://res.cloudinary.com/zinedine-fernando-herrera/image/upload/v1697334310/fnprwqehecx7th0okbgh.jpg';

interface CardShoppingProp {
  orderItem: IOrderItem;
}

const CardShopping: FC<CardShoppingProp> = ({ orderItem }) => {
  const { addOrders, subtractOrders, removeOrders } = useOrderStore();
  ...
  return (
    <div className='flex items-center justify-between bg-gray-100 p-4 rounded-lg'>
      ...
      <button
        onClick={() => removeOrders(orderItem.product.id)}
